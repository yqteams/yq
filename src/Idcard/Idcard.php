...
class Idcard
{
     ...
     * @var array
     */
    private static $factor = [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2];
    /**
     * 校验码对应值
     * @access private
     * @var array
     */
    private static $verify_code_list = ['1', '0', 'X', '9', '8', '7', '6', '5', '4', '3', '2'];
    ...
    public static function getInstance($id = '')
    {
        if (!(self::$_instance instanceof self)) {
            ...
            // 初始化地区列表
            $path              = dirname(__FILE__) . '/data/region.json';
            $region_list       = file_get_contents($path);
